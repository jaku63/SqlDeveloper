--------------------------------------------------------
--  DDL for View VREP_DOLO_LIME
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "VREP_DOLO_LIME" ("DATE1", "SAMPLE_REC_TIME", "SAMPLE_NO", "Al2O3", "CAO", "MGO", "SIO", "P2O3", "REMARKS") AS 
...
WHERE C_MATERIAL_ID IN
  (SELECT ID FROM C_MATERIAL WHERE UPPER(MAT_CODE) LIKE 'DOLO%'
  );
